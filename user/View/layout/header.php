    ...
    <header id="header">
        <div class="d-flex flex-column">
            ...
            <div class="profile">
                <img src="<?= $dataList['avatar']; ?>" alt="" class="img-fluid rounded-circle">
                <h1 class="text-light"><a href="index.html"><?= $dataList['name']; ?></a></h1>
            ...
            <nav id="navbar" class="nav-menu navbar">
                <ul>
                    ...
                    <li><a href="index.php?controller=logout" class="nav-link scrollto"><i class="bx bx-envelope"></i>
